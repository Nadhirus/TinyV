...
SRC_DIR="../src"
TEST_DIR="../test"
MUX_FILE="$SRC_DIR/core/mux3x1.sv"
TB_FILE="$TEST_DIR/mux3x1_tb.sv"
VCD_FILE="mux3x1_dump.vcd"
SIMULATION_FILE="mux3x1_simulation.vvp"

# Simulation setup message
echo "Starting simulation for mux3x1..."
